...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    dateRange: '2021 — 2024',
    description: 'Fostered collaboration among junior developers, improved code quality through testing and secure ' +
        'practices, and built a streamlined CI/CD pipeline. Engaged with clients to ensure features met their needs ' +
        'and delivered lasting value. Maintained a strong emphasis on secure coding practices and conducted annual ' +
        'penetration tests to safeguard sensitive data, ensuring industry compliance.',
  ...
  },
  {
    ...
    dateRange: '2018 — 2021',
    description: 'Worked with stakeholders to enhance a bespoke enterprise system, addressing issues and adding ' +
        'new features. Supported greenfield projects, facilitated team communication as a part-time scrum master, ' +
        'and improved workflow through sprint planning and retrospectives.',
